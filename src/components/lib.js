...
const scripts = [
	...
	'https://cdn.jsdelivr.net/npm/astro@2.10.12/astro.min.js',
	'https://cdn.jsdelivr.net/npm/solid-js@1.7.11/dist/solid.min.js',
	'https://cdn.jsdelivr.net/npm/react@18.2.0/umd/react.production.min.js',
	'https://cdn.jsdelivr.net/npm/react-dom@18.2.0/index.min.js',
	'https://cdn.jsdelivr.net/npm/typescript@5.1.6/lib/typescript.min.js',
...
console.log('Welcome to the DevConsole.')
console.log('If you are not a developer please leave.')
console.log(
	'This site is copyrighted: (C) Copyright 2023 Ranuka Dinsitha Github. All rights reserved.'
)
