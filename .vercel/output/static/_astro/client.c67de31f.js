...
function fc(e) {
	return e === null || typeof e != 'object'
		? null
		: ((e = (Mo && e[Mo]) || e['@@iterator']), typeof e == 'function' ? e : null)
}
var Hi = {
		isMounted: function () {
			return !1
				...
				: l != null &&
				  ($u(l) &&
						(l = dc(
							l,
							t +
								(!l.key || (o && o.key === l.key) ? '' : ('' + l.key).replace(Do, '$&/') + '/') +
								e
						)),
				  n.push(l)),
			1
		...
		(e.unstable_scheduleCallback = function (C, N, z) {
			...
			return (
				...
				z > B
					? ((C.sortIndex = z),
					  n(c, C),
					  t(s) === null && C === t(c) && (k ? (f(P), (P = -1)) : (k = !0), vl(h, z - B)))
...
function at(e) {
	return e === null || typeof e != 'object'
		? null
		: ((e = (jo && e[jo]) || e['@@iterator']), typeof e == 'function' ? e : null)
}
var A = Object.assign,
	gl
function yt(e) {
...
function dt(e, n) {
	e.blockedOn === n &&
		((e.blockedOn = null),
		ou || ((ou = !0), he.unstable_scheduleCallback(he.unstable_NormalPriority, Wc)))
}
function It(e) {
	function n(l) {
		return dt(l, e)
...
function Zu(e, n, t, r) {
	if (Dr) {
		...
		if (l === null) Ml(e, n, r, Ir, t), Qo(e, r)
			...
			for (; l !== null; ) {
				var u = Zt(l)
				if ((u !== null && _s(u), (u = iu(e, n, t, r)), u === null && Ml(e, n, r, Ir, t), u === l))
					break
				l = u
			}
...
function wf(e, n) {
	if (In)
		return e === 'compositionend' || (!eo && Ms(e, n))
			? ((e = Ls()), (kr = Ju = be = null), (In = !1), e)
			: null
	switch (e) {
		case 'paste':
			return null
...
function Ds(e, n, t, r) {
	fs(r),
		(n = Fr(n, 'onChange')),
		0 < n.length &&
			((t = new qu('onChange', 'change', null, t, r)), e.push({ event: t, listeners: n }))
}
var _t = null,
	Ft = null
function Sf(e) {
...
function Ks(e, n, t, r) {
	...
	;(t = l.bind(null, n, t, e)),
		(l = void 0),
		!ru || (n !== 'touchstart' && n !== 'touchmove' && n !== 'wheel') || (l = !0),
		r
			? l !== void 0
			...
			if (p !== void 0) {
				...
				for (var a = c, d; a !== null; ) {
					...
					if (
						(d.tag === 5 &&
							h !== null &&
							((d = h), f !== null && ((h = Mt(a, f)), h != null && k.push($t(a, h, d)))),
						F)
					)
						break
					a = a.return
		...
		if (!(n & 7)) {
			e: {
				if (
					...
					p && t !== nu && (w = t.relatedTarget || t.fromElement) && (kn(w) || w[We]))
				)
					break e
				if (
					(g || p) &&
					...
					if (
						...
						(e === 'pointerout' || e === 'pointerover') &&
							((k = Zo), (h = 'onPointerLeave'), (f = 'onPointerEnter'), (a = 'pointer')),
						(F = g == null ? p : Un(g)),
						(d = w == null ? p : Un(w)),
			...
			P &&
				(Rs &&
					...
					(In || P !== 'onCompositionStart'
						? P === 'onCompositionEnd' && In && (x = Ls())
						: ((be = v), (Ju = 'value' in be ? be.value : be.textContent), (In = !0))),
				(_ = Fr(c, P)),
				0 < _.length &&
...
function fr(e) {
	...
	if (
		((n = e.tag !== 3) &&
			!(n = e.tag !== 5) &&
			((n = e.type), (n = n !== 'head' && n !== 'body' && !du(e.type, e.memoizedProps))),
		n && (n = me))
	) {
...
function ta(e) {
	...
	function s(f, a, d, h) {
		...
		return E === Dn
			...
			: a !== null &&
			  (a.elementType === E ||
					(typeof E == 'object' && E !== null && E.$$typeof === Ge && wi(E) === a.type))
						...
						for (var E = d.key, _ = a; _ !== null; ) {
							if (_.key === E) {
								if (((E = d.type), E === Dn)) {
									...
									_.elementType === E ||
									(typeof E == 'object' && E !== null && E.$$typeof === Ge && wi(E) === _.type)
								) {
									t(f, _.sibling),
										(a = l(_, d.props)),
										(a.ref = mt(f, _, d)),
...
function oa(e, n) {
	...
	if (
		...
		(r = r.queue),
		yo(aa.bind(null, t, r, e), [e]),
		r.getSnapshot !== n || u || (G !== null && G.memoizedState.tag & 1))
	) {
		if (((t.flags |= 2048), Qt(9, sa.bind(null, t, r, l, n), void 0, null), Z === null))
			throw Error(y(349))
		Nn & 30 || ia(t, n, l)
	}
	return l
...
function wa(e, n, t) {
	return Nn & 21
		? (Me(t, n) || ((t = Es()), ($.lanes |= t), (zn |= t), (e.baseState = !0)), n)
...
function Wf(e, n, t) {
	var r = sn(e)
	if (((t = { lane: r, action: t, hasEagerState: !1, eagerState: null, next: null }), Sa(e)))
		Ea(n, t)
		...
		if (e.lanes === 0 && (u === null || u.lanes === 0) && ((u = n.lastRenderedReducer), u !== null))
			try {
				...
				if (((l.hasEagerState = !0), (l.eagerState = i), Me(i, o))) {
					var s = n.interleaved
					s === null ? ((l.next = l), so(n)) : ((l.next = s.next), (s.next = l)),
						(n.interleaved = l)
					return
				}
			} catch {
...
var Yr = {
	...
	Kf = {
		...
		useSyncExternalStore: function (e, n, t) {
			...
			return (
				(l.queue = u),
				Si(aa.bind(null, r, u, e), [e]),
				(r.flags |= 2048),
				Qt(9, sa.bind(null, r, u, t, n), void 0, null),
				t
			)
		},
		useId: function () {
...
function Na(e, n, t) {
	...
	if (r.mode === 'hidden')
		if (!(n.mode & 1))
			(n.memoizedState = { baseLanes: 0, cachePool: null, transitions: null }), O(Wn, pe), (pe |= t)
		else {
			if (!(t & 1073741824))
				return (
		...
		u !== null ? ((r = u.baseLanes | t), (n.memoizedState = null)) : (r = t), O(Wn, pe), (pe |= r)
			...
			if (!r.hasOwnProperty(c) && l.hasOwnProperty(c) && l[c] != null)
				if (c === 'style') {
					...
					c !== 'dangerouslySetInnerHTML' &&
						...
						c !== 'autoFocus' &&
						(Lt.hasOwnProperty(c) ? u || (u = []) : (u = u || []).push(c, null))
		for (c in r) {
			var s = r[c]
							...
							o === 'children'
								? typeof i == 'string'
									...
									: typeof i == 'number' &&
									  ...
									  (u.suppressHydrationWarning !== !0 && cr(r.textContent, i, e),
									  (l = ['children', '' + i]))
								: Lt.hasOwnProperty(o) && i != null && o === 'onScroll' && D('scroll', r)
						}
					switch (t) {
						case 'input':
							tr(r), $o(r, u, !0)
			...
			return n.flags & 128
				...
				: ((r = r !== null),
				  r !== (e !== null && e.memoizedState !== null) &&
						r &&
						((n.child.flags |= 8192),
						n.mode & 1 && (e === null || U.current & 1 ? Y === 0 && (Y = 3) : xo())),
...
function ed(e, n) {
	switch ((ro(n), n.tag)) {
		case 1:
			return (
				fe(n.type) && Ur(), (e = n.flags), e & 65536 ? ((n.flags = (e & -65537) | 128), n) : null
			)
		case 3:
			return (
				nt(),
...
function Ia(e) {
	...
	n !== null && ((e.alternate = null), Ia(n)),
		...
		e.tag === 5 &&
			((n = e.stateNode),
			n !== null && (delete n[Ie], delete n[At], delete n[mu], delete n[Uf], delete n[$f])),
		(e.stateNode = null),
		(e.return = null),
		(e.dependencies = null),
...
function Re(e, n, t, r) {
	...
	Xt(e, t, r),
		(!(R & 2) || e !== Z) &&
			...
			de(e, r),
			t === 1 && R === 0 && !(n.mode & 1) && ((rt = W() + 500), ll && mn()))
}
function de(e, n) {
...
function Aa(e, n) {
	...
	if (n !== 0) {
		if ((n === 2 && ((l = uu(e)), l !== 0 && ((r = l), (n = Ou(e, l)))), n === 1))
		...
		if (n === 6) qe(e, r)
			...
			if (
				...
				!(r & 30) &&
					!ud(l) &&
					((n = Jr(e, r)), n === 2 && ((u = uu(e)), u !== 0 && ((r = u), (n = Ou(e, u)))), n === 1))
			)
				throw ((t = Kt), Cn(e, 0), qe(e, r), de(e, W()), t)
...
function qe(e, n) {
	for (
		n &= ~So, n &= ~sl, e.suspendedLanes |= n, e.pingedLanes &= ~n, e = e.expirationTimes;
		0 < n;
...
function xo() {
	;(Y === 0 || Y === 3 || Y === 2) && (Y = 4),
		Z === null || (!(zn & 268435455) && !(sl & 268435455)) || qe(Z, q)
}
function Jr(e, n) {
	var t = R
	R |= 2
...
function ad(e, n, t) {
	...
	r !== null && r.delete(n),
		...
		Z === e &&
			(q & t) === t &&
			(Y === 4 || (Y === 3 && (q & 130023424) === q && 500 > W() - Eo) ? Cn(e, 0) : (So |= t)),
		de(e, n)
}
function Qa(e, n) {
...
function al(e, n, t, r) {
	return (
		(e = Se(22, e, r, n)), (e.elementType = ts), (e.lanes = t), (e.stateNode = { isHidden: !1 }), e
	)
}
function Vl(e, n, t) {
...
ye.hydrateRoot = function (e, n, t) {
	...
	if (
		...
		(n = Ga(n, null, e, 1, t ?? null, l, !1, u, o)),
		(e[We] = n.current),
		Ut(e),
		r)
	)
...
var kd = Gi.exports,
	...
	ba,
	Ai = kd
;(ba = Ai.createRoot), (qa = Ai.hydrateRoot)
const Iu = ({ value: e, name: n, hydrate: t = !0 }) => {
	if (!e) return null
	const r = t ? 'astro-slot' : 'astro-static-slot'
	return wn.createElement(r, {
		name: n,
...
const Ed =
	...
	(n, t, { default: r, ...l }, { client: u }) => {
		...
		for (const [c, v] of Object.entries(l)) t[c] = wn.createElement(Iu, { value: v, name: c })
		const i = wn.createElement(n, t, r != null ? wn.createElement(Iu, { value: r }) : r),
			s = Sd(e)
		return (
			s && delete e[s],
			u === 'only'
